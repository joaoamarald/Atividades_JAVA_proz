...
public class atividade_3 {
    ...
    public static void main(String[] args) {
        atividade_3 jogo = new atividade_3();
        String continuar;
        do {
